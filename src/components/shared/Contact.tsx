    ...
    return (
        <div className="flex justify-center items-center gap-5 flex-col" id="contact">
            ...
            <span className=" font-normal text-sm md:text-lg text-center">
                ...
                <a className=" text-blue-500 font-bold" href="https://twitter.com/ilakshaygupt" target="_blank">
                    Twitter
                </a>{" "}
                if that&apos;s more your speed.
            </span>
            <a href="mailto:iamlakshay04@gmail.com?body=Hello" target="_blank" className="flex items-center gap-2 text-xl font-medium">
                <MailPlus /> iamlakshay04@gmail.com
            </a>
