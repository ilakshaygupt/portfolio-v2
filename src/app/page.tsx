...
import { ChevronRight, MailPlus, MouseIcon } from "lucide-react";
        ...
        <section className="lg:max-w-[50%] mt-20 md:mt-36 md:max-w-[90%] relative md:m-auto p-4 flex flex-col min-h-screen">
            <div className=" flex gap-3 flex-col justify-center items-left min-h-[60vh] lg:min-h-screen">
                <div className="flex items-center gap-3">
                    <h1 className="text-4xl flex gap-12 items-center flex-row md:text-7xl lg:text-8xl font-bold ">Hey, I&apos;m Lakshay</h1>
                ...
                <div className="flex items-center gap-3 lg:gap-6 flex-wrap">
                    ...
                    <a href="mailto:iamlakhshay04@gmail.com?body=Hello" target="_blank" rel="noopener noreferrer">
